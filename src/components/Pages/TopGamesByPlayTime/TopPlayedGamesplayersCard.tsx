import './TopPlayedGamesplayersCard.css'


export function TopPlayedGamesByPlaytimeCard(item:any){
return (<>
<div className="games-list">
  <div className="game-card">
    ...
    <div className="game-details">
      ...
      <p className="game-platform">Totale Players : {item.userIds.map(((el:any)=><li>{el}</li>))}</p>
